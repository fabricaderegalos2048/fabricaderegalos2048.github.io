...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            background: url('/img/gif2.gif') center center / cover no-repeat;
            z-index: -2;
        }
...
<body>
    ...
    <button id="cursed-button">NO PULSES<br>EL BOTÓN</button>
    ...
    <script>
        ...
        function triggerFinalScreamer() {
            ...
            screamerImage.src = '/img/screamer1.jpg?' + Date.now();
            screamerOverlay.style.display = 'block';
